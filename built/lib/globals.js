...
const swcTrading_1 = require("../managers/swcTrading");
global.Tmp = {};
...
global.SpawnBreaker = function (city, boosted) {
    ...
    sq.schedule(Game.spawns[city], "medic" /* MEDIC_NAME */, boosted);
    sq.schedule(Game.spawns[city], "breaker" /* BREAKER_NAME */, boosted);
...
global.RequestResource = function (roomName, resourceType, maxAmount, priority) {
    ...
    swcTrading_1.simpleAllies.requestResource(request);
...
global.RemoveJunk = function (city) {
...
global.DropRemote = function (remoteRoomName) {
